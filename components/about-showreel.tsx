...
export function AboutShowreel() {
  ...
  useEffect(() => {
    ...
    const updateLayout = () => {
      ...
      const scale = 1.75;
      const baseLeft =
        offsetParent.getBoundingClientRect().left + video.offsetLeft;
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-[1360px] grid-cols-1 items-start gap-10 px-6 sm:px-10 md:px-14 lg:min-h-[178svh] lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)] lg:gap-14 min-[1360px]:gap-20">
        ...
        >
          <div className="flex h-full w-full items-center justify-center px-10 text-center">
            <p className="font-sans text-[clamp(1rem,1.4vw,1.25rem)] font-medium tracking-[-0.02em] text-[#0A0A0A]">
              Currently optimized for desktop, more coming soon.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-[32rem] lg:-mt-[3.5rem] lg:translate-x-6 lg:justify-self-end min-[1360px]:-mt-[4.5rem] min-[1360px]:translate-x-8">
          <p className="font-sans text-[clamp(0.9rem,1.2vw,1rem)] font-medium leading-[1.65] tracking-[-0.01em] text-[#0A0A0A]">
            I am passionate about creating thoughtful digital experiences that feel intuitive, useful, and enjoyable. I am particularly fascinated by the potential of AI to empower people, simplify complexity, and enrich everyday life.
          </p>
        </div>
      </div>
    </section>
